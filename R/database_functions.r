...
initialize_db <- function() {
  ...
  if (all(check)) {
    ...
    lst_schema <- c(
      ...
      "CREATE TABLE data_control(location VARCHAR, keyword VARCHAR, date DATE, hits FLOAT, batch INTEGER);",
      "CREATE TABLE data_doi(keyword VARCHAR, date DATE, gini FLOAT, hhi FLOAT, entropy FLOAT, batch_c INTEGER, batch_o INTEGER, locations VARCHAR);",
      "CREATE TABLE data_locations(location VARCHAR, type VARCHAR);",
      "CREATE TABLE data_object(location VARCHAR, keyword VARCHAR, date DATE, hits FLOAT, batch_c INTEGER, batch_o INTEGER);",
      "CREATE TABLE data_score(location VARCHAR, keyword VARCHAR, date DATE, score FLOAT, batch_c INTEGER, batch_o INTEGER);",
